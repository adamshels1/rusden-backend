...
{
  "category": "realty" | "job" | "service" | "goods" | "car_rental" | "other",
  "subcategory": "для realty: sale или rent. Для остальных категорий можно описать точнее (например: мебель, техника, вакансия официанта)",
