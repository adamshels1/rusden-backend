...
**Категории:**
- realty: недвижимость (с подкатегориями: sale - продажа, rent - аренда)
...
- auto: автомобили (с подкатегориями: sale - продажа, rent - аренда)

**Отвечай ТОЛЬКО в JSON формате:**
{
  "category": "realty" | "job" | "service" | "goods" | "auto" | "other",
  "subcategory": "для realty и auto: sale или rent. Для остальных категорий можно описать точнее (например: мебель, техника, вакансия официанта)",
