...
2. Сохраняет raw сообщения в базу данных
3. Обрабатывает через Groq AI (llama-3.3-70b-versatile)
4. Создает структурированные объявления
5. Делает их доступными через API
